...
$color_families = array(
    'Red' => array(
        ...
        array('name' => 'SW 6333 - Blushing Pink', 'hex' => '#F5E5E8'),
        array('name' => 'SW 6334 - Rosy Outlook', 'hex' => '#F0DAE0'),
    ),
    'Orange' => array(
        ...
        array('name' => 'SW 6345 - Copper Harbor', 'hex' => '#C65529'),
        array('name' => 'SW 6346 - Copper Pot', 'hex' => '#B84C21'),
        array('name' => 'SW 6347 - Hearty Orange', 'hex' => '#AA4419'),
    ),
    'Yellow' => array(
        ...
        array('name' => 'SW 6356 - Goldenrod', 'hex' => '#E2A00B'),
        array('name' => 'SW 6357 - Osage Orange', 'hex' => '#DB9503'),
        array('name' => 'SW 6358 - Gold Rush', 'hex' => '#D48A00'),
        array('name' => 'SW 6359 - Glitzy Gold', 'hex' => '#F4E7C3'),
    ),
    'Green' => array(
        ...
        array('name' => 'SW 6428 - Lounge Green', 'hex' => '#5FA660'),
        array('name' => 'SW 6429 - Envy', 'hex' => '#4F9D53'),
        array('name' => 'SW 6430 - Julep', 'hex' => '#3F9446'),
        array('name' => 'SW 6431 - Direct Green', 'hex' => '#2F8B39'),
        array('name' => 'SW 6432 - Greenbelt', 'hex' => '#20822C'),
    ),
    'Teal' => array(
        array('name' => 'SW 6760 - Aquarium', 'hex' => '#5FB0B7'),
        array('name' => 'SW 6761 - Cooled Blue', 'hex' => '#4FA6AD'),
        array('name' => 'SW 6762 - Mariner', 'hex' => '#3F9CA3'),
        array('name' => 'SW 6763 - Surfer', 'hex' => '#2F9299'),
        array('name' => 'SW 6764 - Thermal Spring', 'hex' => '#20888F'),
        array('name' => 'SW 6765 - Intense Teal', 'hex' => '#107E85'),
        array('name' => 'SW 6766 - Grand Canal', 'hex' => '#00747B'),
        array('name' => 'SW 6767 - Holiday Turquoise', 'hex' => '#00CED1'),
        array('name' => 'SW 6768 - Tempo Teal', 'hex' => '#00B8BB'),
        array('name' => 'SW 6769 - Nifty Turquoise', 'hex' => '#00A2A5'),
        array('name' => 'SW 6770 - Biscay', 'hex' => '#008C8F'),
        array('name' => 'SW 6771 - Tidal Wave', 'hex' => '#007679'),
        array('name' => 'SW 6772 - Lagoon', 'hex' => '#006063'),
        array('name' => 'SW 6773 - Green Bay', 'hex' => '#004A4D'),
    ),
    'Blue' => array(
        ...
        array('name' => 'SW 6504 - Dazzling Blue', 'hex' => '#2990C7'),
        array('name' => 'SW 6505 - Loch Blue', 'hex' => '#1788C3'),
        array('name' => 'SW 6506 - Blue Chip', 'hex' => '#0580BF'),
        array('name' => 'SW 6507 - Danube', 'hex' => '#0078BB'),
        array('name' => 'SW 6508 - Adriatic Sea', 'hex' => '#C8E4F0'),
    ),
    'Purple' => array(
        ...
        array('name' => 'SW 6555 - Gutsy Grape', 'hex' => '#8C579D'),
        array('name' => 'SW 6556 - Vigorous Violet', 'hex' => '#834B95'),
        array('name' => 'SW 6557 - Impulsive Purple', 'hex' => '#7A3F8D'),
        array('name' => 'SW 6558 - Passionate Purple', 'hex' => '#713385'),
    ),
    'Neutral' => array(
        ...
        array('name' => 'SW 7036 - Accessible Beige', 'hex' => '#D1C7B8'),
        array('name' => 'SW 7037 - Balanced Beige', 'hex' => '#C5BCA9'),
        array('name' => 'SW 7038 - Tony Taupe', 'hex' => '#B9B09A'),
        array('name' => 'SW 7039 - Virtual Taupe', 'hex' => '#ADA48B'),
        array('name' => 'SW 7040 - On the Rocks', 'hex' => '#A1987C'),
    ),
    'Gray' => array(
        ...
        array('name' => 'SW 7069 - Iron Gate', 'hex' => '#7B7977'),
        array('name' => 'SW 7070 - Site White', 'hex' => '#EFEDE7'),
        array('name' => 'SW 7071 - SW Lattice', 'hex' => '#DEDCD5'),
        array('name' => 'SW 7072 - Passive', 'hex' => '#CECBC3'),
        array('name' => 'SW 7073 - Pewter Cast', 'hex' => '#BEBBB1'),
    ),
    'Brown' => array(
        array('name' => 'SW 6104 - Cascade Green', 'hex' => '#7A7568'),
        array('name' => 'SW 6105 - Tea Chest', 'hex' => '#6E6B5E'),
        array('name' => 'SW 6106 - Eclipse', 'hex' => '#625F54'),
        array('name' => 'SW 6107 - Homestead Brown', 'hex' => '#56534A'),
        array('name' => 'SW 6108 - Otter', 'hex' => '#4A4740'),
        array('name' => 'SW 6258 - Tricorn Black', 'hex' => '#2F2F30'),
        array('name' => 'SW 6258 - Black Bean', 'hex' => '#3B3A36'),
        array('name' => 'SW 2807 - Coconut Husk', 'hex' => '#8B7355'),
        array('name' => 'SW 2808 - Renwick Golden Oak', 'hex' => '#806647'),
        array('name' => 'SW 2809 - Java', 'hex' => '#755939'),
        array('name' => 'SW 2810 - Sturdy Brown', 'hex' => '#6A4C2B'),
        array('name' => 'SW 2811 - Umber', 'hex' => '#5F3F1D'),
        array('name' => 'SW 2812 - French Roast', 'hex' => '#54320F'),
        array('name' => 'SW 2813 - Van Dyke Brown', 'hex' => '#492501'),
    ),
);
?>
