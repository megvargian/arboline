		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				...
				<span class="password-input-wrapper">
					...
					<span class="show-password-input" data-toggle="0">
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<?php else : ?>
				...
				<p class="register-password-info"><?php esc_html_e( 'A link to set a new password will be sent to your email address.', 'woocommerce' ); ?></p>

			<?php endif; ?>

			<p class="register-privacy-policy">
				...
				<a href="<?php echo esc_url( get_privacy_policy_url() ); ?>"><?php esc_html_e( 'privacy policy', 'woocommerce' ); ?></a>.
			</p>
