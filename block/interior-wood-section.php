...
<!-- <div class="wp-block-cover alignfull is-light my-0" style="min-height:60vh">
    <span aria-hidden="true"
        class="wp-block-cover__background has-white-background-color has-background-dim-90 has-background-dim"></span>
        ...
        <div class="is-layout-flow wp-block-group alignfull mb-0 has-background" style="background-color:#ffffff00">
            <div
                ...
                <div class="is-layout-flow wp-block-column is-vertically-aligned-top">
                    ...
                    <p class="has-text-align-center mb-lg-5 mb-4 has-medium-font-size"><?php echo esc_html($text); ?>
                    </p>
                    <?php if ($products): ?>
                ...
                <div class="is-layout-flow wp-block-column is-vertically-aligned-center">
                    <figure><img src="<?php echo esc_url($finishes_image); ?>" alt="Finishes" width="896" height="794">
                    </figure>
                </div>
            </div>
        </div>
...
<div class="wp-block-cover alignfull is-light my-0" style="min-height:60vh"><span aria-hidden="true"
        ...
        class="wp-block-cover__image-background wp-image-2499" alt="" src="<?php echo esc_url($background_image); ?>"
        style="object-position:9% 35%" data-object-fit="cover" data-object-position="9% 35%"
            ...
            <div
                ...
                <div class="is-layout-flow wp-block-column is-vertically-aligned-top">
                    <figure class="wp-block-image size-full mb-0"><img decoding="async" loading="lazy" width="896"
                            height="794" src="<?php echo esc_url($finishes_image); ?>" alt="" class="wp-image-3252"
                ...
                <div class="is-layout-flow wp-block-column is-vertically-aligned-top">
                    ...
                    <h3 class="has-text-align-center underline h1"><span style="text-decoration: underline;"><a
                                href="#"><?php echo esc_html($title); ?></a></span></h3>
